...
permalink: environment--edgemere-diml-ddf-dr-test
nav_exclude: true
---
...
The Data Repository subsystem is physically laid out on a hybrid cloud infrastructure.
...
| --- | --- | --- | --- | --- |
| frontend | diml_ddf_dr_web |  |  | sibling |
| gw | diml_ddf_dr_gw |  |  | children,sibling |
...
| --- | --- | --- | --- |
| children | egress | ailtire_appname_diml_ddf_dr_family |
| sibling | internal |  |
