...
permalink: environment--edgemere-diml-ddf-df-test
nav_exclude: true
---
...
The Data Flow subsystem is physically laid out on a hybrid cloud infrastructure.
...
| --- | --- | --- | --- | --- |
| frontend | diml_ddf_df_web |  |  | sibling |
| gw | diml_ddf_df_gw |  |  | children,sibling |
...
| --- | --- | --- | --- |
| children | egress | ailtire_appname_diml_ddf_df_family |
| sibling | internal |  |
