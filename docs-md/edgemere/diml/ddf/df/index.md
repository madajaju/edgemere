...
## Logical Artifacts
The Data Model for the  Data Flow shows how the different objects and classes of object interact
and their structure.
...
The Data Flow subsystem provides the following activities and flows.
...
The Data Flow subsystem is is physically laid out on a hybrid cloud infrastructure. Each microservice is shown
