...
permalink: environment--edgemere-diml-ddf-daf-prod
nav_exclude: true
---
...
The Data Adaptor Framework subsystem is physically laid out on a hybrid cloud infrastructure.
...
| --- | --- | --- | --- | --- |
| frontend | diml_ddf_daf_web |  |  | sibling |
| gw | diml_ddf_daf_gw |  |  | children,sibling |
...
| --- | --- | --- | --- |
| children | egress | ailtire_appname_diml_ddf_daf_family |
| sibling | internal |  |
| parent | ingress | ailtire_appname_diml_ddf_family |
