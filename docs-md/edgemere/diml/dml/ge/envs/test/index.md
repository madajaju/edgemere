...
permalink: environment--edgemere-diml-dml-ge-test
nav_exclude: true
---
...
The Governance Engine subsystem is physically laid out on a hybrid cloud infrastructure.
...
| --- | --- | --- | --- | --- |
| frontend | diml_dml_ge_web |  |  | sibling |
| gw | diml_dml_ge_gw |  |  | children,sibling |
...
| --- | --- | --- | --- |
| children | egress | ailtire_appname_diml_dml_ge_family |
| sibling | internal |  |
