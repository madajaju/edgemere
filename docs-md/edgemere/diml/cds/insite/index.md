...
## Logical Artifacts
The Data Model for the  Insite Services shows how the different objects and classes of object interact
and their structure.
...
The Insite Services subsystem is is physically laid out on a hybrid cloud infrastructure. Each microservice is shown
