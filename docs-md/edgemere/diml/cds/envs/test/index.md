...
permalink: environment--edgemere-diml-cds-test
nav_exclude: true
---
...
The Common Data Service subsystem is physically laid out on a hybrid cloud infrastructure.
...
| --- | --- | --- | --- | --- |
| frontend | diml_cds_web |  |  | sibling |
| gw | diml_cds_gw |  |  | children,sibling |
...
| --- | --- | --- | --- |
| children | egress | ailtire_appname_diml_cds_family |
| sibling | internal |  |
