...
permalink: environment--edgemere-sml-pe-prod
nav_exclude: true
---
...
The Provision Engine subsystem is physically laid out on a hybrid cloud infrastructure.
...
| --- | --- | --- | --- | --- |
| frontend | sml_pe_web |  |  | sibling |
| gw | sml_pe_gw |  |  | children,sibling |
...
| --- | --- | --- | --- |
| children | egress | ailtire_appname_sml_pe_family |
| sibling | internal |  |
