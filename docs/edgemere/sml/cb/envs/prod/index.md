...
permalink: environment--edgemere-sml-cb-prod
nav_exclude: true
---
...
The Cloud Broker subsystem is physically laid out on a hybrid cloud infrastructure.
...
| --- | --- | --- | --- | --- |
| frontend | sml_cb_web |  |  | sibling |
| gw | sml_cb_gw |  |  | children,sibling |
...
| --- | --- | --- | --- |
| children | egress | ailtire_appname_sml_cb_family |
| sibling | internal |  |
