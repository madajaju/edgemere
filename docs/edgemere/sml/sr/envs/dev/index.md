...
permalink: environment--edgemere-sml-sr-dev
parent: environment-dev
grand_parent: Environments
---

### Service Repository dev
...
The Service Repository subsystem is physically laid out on a hybrid cloud infrastructure.
