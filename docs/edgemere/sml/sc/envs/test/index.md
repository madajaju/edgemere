...
permalink: environment--edgemere-sml-sc-test
nav_exclude: true
---
...
The Service Controller subsystem is physically laid out on a hybrid cloud infrastructure.
...
| --- | --- | --- | --- | --- |
| frontend | sml_sc_web |  |  | sibling |
| gw | sml_sc_gw |  |  | children,sibling |
...
| --- | --- | --- | --- |
| children | egress | ailtire_appname_sml_sc_family |
| sibling | internal |  |
