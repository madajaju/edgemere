...
permalink: environment--edgemere-aml-ams-test
nav_exclude: true
---
...
The AI ML Services subsystem is physically laid out on a hybrid cloud infrastructure.
...
| --- | --- | --- | --- | --- |
| frontend | aml_ams_web |  |  | sibling |
| gw | aml_ams_gw |  |  | children,sibling |
...
| --- | --- | --- | --- |
| children | egress | ailtire_appname_aml_ams_family |
| sibling | internal |  |
