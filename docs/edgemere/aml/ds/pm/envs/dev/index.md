...
permalink: environment--edgemere-aml-ds-pm-dev
parent: environment-dev
grand_parent: Environments
---

### Pipeline Manager dev
...
The Pipeline Manager subsystem is physically laid out on a hybrid cloud infrastructure.
...
| frontend | a_d_pm_web |  |  | sibling |
| gw | a_d_pm_gw |  |  | children,sibling |
...
| --- | --- | --- | --- |
| children | egress | appname_a_d_pm_family |
| sibling | internal |  |
