...
permalink: environment--edgemere-aml-ds-prod
nav_exclude: true
---
...
The Developer Services subsystem is physically laid out on a hybrid cloud infrastructure.
...
| --- | --- | --- | --- | --- |
| frontend | aml_ds_web |  |  | sibling |
| gw | aml_ds_gw |  |  | children,sibling |
...
| --- | --- | --- | --- |
| children | egress | ailtire_appname_aml_ds_family |
| sibling | internal |  |
