...
permalink: environment--edgemere-aml-ds-em-test
nav_exclude: true
---
...
The Environment Management subsystem is physically laid out on a hybrid cloud infrastructure.
...
| --- | --- | --- | --- | --- |
| frontend | sml_em_web |  |  | sibling |
| gw | sml_em_gw |  |  | children,sibling |
...
| --- | --- | --- | --- |
| children | egress | ailtire_appname_sml_em_family |
| sibling | internal |  |
