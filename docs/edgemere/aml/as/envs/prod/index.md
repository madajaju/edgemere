...
permalink: environment--edgemere-aml-as-prod
nav_exclude: true
---
...
The Analytics Services subsystem is physically laid out on a hybrid cloud infrastructure.
...
| --- | --- | --- | --- | --- |
| frontend | aml_as_web |  |  | sibling |
| gw | aml_as_gw |  |  | children,sibling |
...
| --- | --- | --- | --- |
| children | egress | ailtire_appname_aml_as_family |
| sibling | internal |  |
