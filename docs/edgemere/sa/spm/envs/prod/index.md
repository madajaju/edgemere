...
permalink: environment--edgemere-sa-spm-prod
parent: environment-prod
grand_parent: Environments
---

### Security Profile Manager prod
...
The Security Profile Manager subsystem is physically laid out on a hybrid cloud infrastructure.
...
| frontend | s_spm_web |  |  | sibling |
| gw | s_spm_gw |  |  | children,sibling |
...
| --- | --- | --- | --- |
| children | egress | appname_s_spm_family |
| sibling | internal |  |
| parent | ingress | appname_s_family |
