...
permalink: environment--edgemere-cpl-tp-prod
parent: environment-prod
grand_parent: Environments
---

### Telemetry Producer prod
...
The Telemetry Producer subsystem is physically laid out on a hybrid cloud infrastructure.
...
| --- | --- | --- | --- | --- |
| producer | cpl_tp_producer:latest |  |  | parent,telemetry |
...
| telemetry | ingress | edgemere_ailtire_parent_network_family |
