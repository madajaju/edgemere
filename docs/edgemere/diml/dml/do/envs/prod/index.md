...
permalink: environment--edgemere-diml-dml-do-prod
nav_exclude: true
---
...
The Data Orchestrator subsystem is physically laid out on a hybrid cloud infrastructure.
...
| --- | --- | --- | --- | --- |
| frontend | diml_dml_do_web |  |  | sibling |
| gw | diml_dml_do_gw |  |  | children,sibling |
...
| --- | --- | --- | --- |
| children | egress | ailtire_appname_diml_dml_do_family |
| sibling | internal |  |
