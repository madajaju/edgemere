...
permalink: environment--edgemere-diml-dml-fmdm-prod
nav_exclude: true
---
...
The Federated Meta Data Management subsystem is physically laid out on a hybrid cloud infrastructure.
...
| --- | --- | --- | --- | --- |
| frontend | diml_dml_fmdm_web |  |  | sibling |
| gw | diml_dml_fmdm_gw |  |  | children,sibling |
...
| --- | --- | --- | --- |
| children | egress | ailtire_appname_diml_dml_fmdm_family |
| sibling | internal |  |
| parent | ingress | ailtire_appname_diml_dml_family |
