...
permalink: environment--edgemere-diml-cds-transform-dev
parent: environment-dev
grand_parent: Environments
---

### Transform Services dev
...
The Transform Services subsystem is physically laid out on a hybrid cloud infrastructure.
