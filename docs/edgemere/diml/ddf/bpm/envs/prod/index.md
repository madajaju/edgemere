...
permalink: environment--edgemere-diml-ddf-bpm-prod
nav_exclude: true
---
...
The Blue Print Management subsystem is physically laid out on a hybrid cloud infrastructure.
...
| --- | --- | --- | --- | --- |
| frontend | diml_ddf_bpm_web |  |  | sibling |
| gw | diml_ddf_bpm_gw |  |  | children,sibling |
...
| --- | --- | --- | --- |
| children | egress | ailtire_appname_diml_ddf_bpm_family |
| sibling | internal |  |
